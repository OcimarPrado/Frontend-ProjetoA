...
import ContatoBot from "./ContatoBot"; // Importação do componente ContatoBot
...
const Footer: React.FC = () => {
  ...
  return (
    <>
      {/* O Componente Bot é renderizado aqui, acima do rodapé */}
      ...
      <footer className="footer">
        <div className="footer-container">
          ...
          <ul className="footer-links">
           ...
           {/*{/* ITEM DE CONTATO QUE ABRE O BOT 
            <li onClick={handleContactClick} style={{cursor: 'pointer'}}>
              <span className="contact-bot-link">Contato</span> 
            </li>*/}
          </ul>
